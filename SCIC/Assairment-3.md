...
## **Assignment 10 – Updated Requirements**

Upgrade your existing project to a **feature-rich, production-ready, and professional standard application.**

This applies to any project type, including **Freelance, Recipe, Event, Sports, E-commerce, Travel, Real Estate, Social, Wallet, Food, AI, Parcel Delivery,** etc.
...
- **Private CRUD pages** must be inside the dashboard; no standalone public CRUD routes.
- **Single-role projects:** If your project has only one role (e.g., User), prepare the dashboard accordingly.
- **Admin role (optional but highly recommended):** If included, implement role-based access control and relevant UI.

**Dashboard Layout**

- Dedicated dashboard layout with top navbar, **profile dropdown** (Profile, Dashboard Home, Logout), and sidebar.
- **Sidebar menu:**
- User role: minimum **2 menu items**
- Admin/Advanced role: minimum **3 menu items** (if admin role is included)

**Dashboard Overview**

- Overview cards.
- Dynamic charts (**Bar, Line, Pie, or other types**) showing **real backend data**.
- Dynamic data table populated from backend.

**Profile Page**

- Full-width layout.
- Editable and readable profile information.
...
- Demo credentials:
- User email & password
- Admin email & password (if included)
